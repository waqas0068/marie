...
<form action="../config/logo_delete.php" method="get">
...
<form action="../config/link_delete.php" method="get">
...
<?php while($cta_row = $cta_result->fetch_assoc()) { ?>
    <form action="../config/delete_hd_btn.php" method="get">
...
<form action="../config/hero_text_delete.php" method="get">
...
<form action="../config/delete_main_text.php" method="get">
...
<form action="../config/first_article_heading_delete.php" method="get">
...
<form action="../config/first_data_delete.php" method="get">
...
<form action="../config/first_data2_delete.php" method="get">
...
<form action="../config/second_art_heading_delete.php" method="get">
...
<form action="../config/second_art_data1_delete.php" method="get">
...
<?php while ($second_art_data2_row=$second_art_data2_result->fetch_assoc()) { ?>
    <form action="../config/second_art_data2_delete.php" method="get">
...
<?php
 ...
 <form action="../config/portfolio_delete.php" method="get">
